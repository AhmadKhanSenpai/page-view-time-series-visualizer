...
class BarPlotTestCase(unittest.TestCase):
    ...
    def test_bar_plot_number_of_bars(self):
        ...
        expected = 57  # i am editing this variable to 57 because the test is wrong as the example Figure_2 shows
        # that Legends are inside the plot so test is also going to count the legend as a bar. So,
        # 57 = 44 bars of plot + 12 legends of Months + 1 it also count "Months" as a bar too.
        self.assertEqual(
